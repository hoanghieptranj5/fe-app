...
export const GlassyCard = styled((props: CardProps) => (
  ...
  boxShadow:
    '0 22px 55px rgba(15,23,42,0.55), 0 0 0 1px rgba(255,255,255,0.12)',
  ...
  '&::before': {
    ...
    inset: '-40%',
    background:
      'radial-gradient(circle at 0% 0%, rgba(96,165,250,0.40) 0, transparent 55%)',
    opacity: 0.55,
    pointerEvents: 'none',
  },
